...
// GET products
export const REFRESH_PRODUCTS_START = "REFRESH_PRODUCTS_START";
export const REFRESH_PRODUCTS_SUCCESS = "REFRESH_PRODUCTS_SUCCESS";
export const REFRESH_PRODUCTS_FAIL = "REFRESH_PRODUCTS_FAIL";
